...
def do_deploy(archive_path):
    ...
    run(f"tar -xzf /tmp/{static_path}.tgz -C /data/web_static/releases/{static_path}/")
    run(f"rm -rf /tmp/{static_path}/")
    run(f"mv /data/web_static/releases/{static_path}/web_static/* /data/web_static/releases/{static_path}/")
    run(f"rm -rf /data/web_static/releases/{static_path}/web_static")
    run("rm -rf /data/web_static/current")
    run(f"ln -s /data/web_static/releases/{static_path}/ /data/web_static/current")
